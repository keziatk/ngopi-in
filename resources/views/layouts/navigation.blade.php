<nav x-data="{ open: false }" class="bg-zinc-900 border-b border-zinc-800 text-zinc-300">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-lg font-bold text-amber-400 tracking-wide">
                        ngopi<span class="text-white">.in</span> ☕
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                        class="text-zinc-300 hover:text-amber-400">
                        Dashboard
                    </x-nav-link>

                    <x-nav-link :href="route('coffees.index')" :active="request()->routeIs('coffees.*')">
                        Kopi
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-sm font-medium rounded-lg
                                   bg-zinc-800 text-zinc-300 hover:text-amber-400 transition">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-zinc-900">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                Dashboard
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('coffees.index')">
                Kopi
            </x-responsive-nav-link>
